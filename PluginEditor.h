...
private:
	...
	//two pointers to the low shelf gain and cutoff sliders
	ScopedPointer<Slider> lowShelfcut;
	ScopedPointer<Slider> lowShelfgain;

	//two pointers to the high shelf gain and cutoff sliders
	ScopedPointer<Slider> highShelfCutSlider;
	ScopedPointer<Slider> highShelfGainSlider;

	//three pointers to the notch sliders
	ScopedPointer<Slider> notchCutSlider;
	ScopedPointer<Slider> notchGainSlider;
	ScopedPointer<Slider> notchQSlider;
